<template>
    <aside class="top-bar" :style="'background-color:' + topBar">
        ...
        <div class="header-btns">
            <button @click="goBack()">
                <span class="arrow-backward material-icons">
                    arrow_back_ios
                </span>
            </button>
            <button @click="goNext()">
        ...
        <div class="account-menu">
            <button
                class="account-btn clear-btn flex justify-center align-center"
            >
                <template v-if="loggedUser">
                    <img src="" v-if="loggedUser.imgUrl" />
                    <span class="user-icon material-icons" v-else>
                        account_circle
                    </span>
                    <p class="highlight small">{{ loggedUser.name }}</p>
                </template>
                <template v-else>
                    <span class="user-icon material-icons">
                        account_circle
                    </span>
